...
public class DeliveryInfoController {
	...
	public Map<String, Object> over(DeliveryInfo deliveryInfo){
		System.out.println("前端传来的结束兼职信息："+ deliveryInfo);
		return deliveryInfoService.over(deliveryInfo);
	}

	@RequestMapping(value="/refuse2", method=RequestMethod.GET)
	public Map<String, Object> addSroce(DeliveryInfo deliveryInfo){
		System.out.println("前端传来的加分信息："+ deliveryInfo);
		return deliveryInfoService.addsroce(deliveryInfo);
	}
